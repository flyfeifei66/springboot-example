package com.zhaojufei.bizline.example.service.billno.service.impl;
...
import com.zhaojufei.bizline.example.core.util.DmDateUtil;
import com.zhaojufei.bizline.example.facade.domain.enums.ResCodeEnum;
import com.zhaojufei.bizline.example.service.billno.bean.BillNoAlloc;
import com.zhaojufei.bizline.example.service.billno.cache.BillNoCache;
import com.zhaojufei.bizline.example.service.billno.entity.BillNoAllocEntity;
import com.zhaojufei.bizline.example.service.billno.enums.BillTypeEnum;
import com.zhaojufei.bizline.example.service.billno.mapper.BillNoAllocMapper;
import com.zhaojufei.bizline.example.service.billno.service.BillNoAllocService;
...
public class BillNoAllocServiceImpl implements BillNoAllocService {
    ...
    public String getBillNo(int billCode, Date date, boolean isPrefix) {
        ...
        if (Objects.isNull(curEnum)) {
            throw new BizException(ResCodeEnum.BILL_TYPE_NOT_EXISTS);
        }
    ...
    public String getBillNoFromDb(int billCode, String prefix, boolean isPrefix, String key, Date date) {
        ...
        if (Objects.isNull(billNoAllocDb)) {
            ...
            newEntity.setAllocId(UUID.randomUUID().toString());
